...
org.Ks <- 0.904855    # [mm/s] - saturated hydraulic condutivity 
org.vwc_s <- 0.84  # [m3/m3] - saturated water content
org.vwc_r <- 0.04  # [m3/m3] - residual water content
org.VG_alpha <- 0.001505242 # [mm-1] - Van Genuchten alpha (Jiang et al. = 12.7 m-1)
org.VG_n <- 2.03565914       # [-] - Van Genuchten n
org.thermcond <- 0.426767772   # [W/m/K] - thermal conductivity of soil solids
...
#   thermal conductivity & capacity from Kurylyk et al. (2016) WRR Table A1
min.Ks <- 0.0125    # [mm/s] - saturated hydraulic condutivity 
