...
plot.path <- paste0(git.dir, "geotop/output-plots/meteo_CompareInputToOutput_20170315-100soil-Top10-1hr-IgnoreP-SnowThres749-Start2006-SnowAlbUp-StabCorr1-MO2-CanIter1000-NewMeteo.png")
